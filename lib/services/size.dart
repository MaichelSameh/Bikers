...
class Size {
  ...
  double? _screenWidth;
  static const double _modelHeight = 736;
  static const double _modelWidth = 414;
  ...
  double height(double number, [bool getFromScreenHeight = false]) {
    double _screenHeight =
  ...
  double width(double number, [bool getFromScreenHeight = false]) {
    double _screenWidth =
